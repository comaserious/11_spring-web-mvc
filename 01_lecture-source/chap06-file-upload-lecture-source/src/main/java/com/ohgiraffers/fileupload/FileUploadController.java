...
public class FileUploadController {
    ...
    public String singleFileUpload(@RequestParam MultipartFile singleFile, @RequestParam String singleFileDescription, Model model) throws IOException {
    ...
    public String multiFileUpload(@RequestParam String multiFilesDescription, @RequestParam List<MultipartFile> multiFiles,Model model) throws IOException {
